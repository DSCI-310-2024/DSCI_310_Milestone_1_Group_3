...
The Python programming language [@R]
and the following R packages were used to perform the analysis: 
[@readr], [@ggplot2], [@ggpairs], [@GGally], [@dplyr], [@rsample],
as well as the following data from official websites of Canadian government and departments: 
[@community_well_being_index_2024], [@nccih_publications_2016], [@five_year_evaluation_plan_2019], [@well_being_measures_canada_2021]
...
dataset <- read_csv("../results/clean_data.csv")
head(dataset)
```
